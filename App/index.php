...
try {
	...
	// ----------- EDIT APPUSER(STUDENT) PROFILE -----------  //
		...
		case "update_picture":
			...
			$target_file = $target_dir . basename($_FILES["savePicture"][$user->getImageFilename()]); //here's where we put in the hashed L#
			$uploadGood = 1;
			...
			if (file_exists($target_file)) {
			 ...
			 // Check file size
			if ($_FILES["savePicture"]["size"] > 100000) { //100kb
				echo "Sorry, your file is too large. Maximum file size is 100KB";
				$uploadGood = 0;
			}
